...
public class HomeController {
		...
		if(session != null && session.isOpen()) {
			...
			try {
				if(VType2 != null && Vnb2 != null)
				{
					...
					else if(StringUtils.equalsIgnoreCase(VType2, "po") && !StringUtils.equalsIgnoreCase(Vnb2, "") ) {
				...
				List<Object[]> listDiscovNewAll = query.list();
						...
						query.setParameter("param1", Vnb2);
						List<Object[]> listDiscovNewNotComp = query.list();
						//List<Object[]> listDiscovNewNotComp = (List<Object[]>) appConfig.findAllByMultiClzQryPrms(getDNewNotComp, "param1", Vnb2);
					...
					/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
						...
						query.setParameter("param1", Vnb2);
						List<Object[]> listCapitalAll = query.list();
						//List<Object[]> listCapitalAll = (List<Object[]>) appConfig.findAllByMultiClzQryPrms(getCapitalInProgr, "param1", Vnb2);
						...
						query.setParameter("param1", Vnb2);
						List<Object[]> listAssetRegAll = query.list();
						//List<Object[]> listAssetRegAll = (List<Object[]>) appConfig.findAllByMultiClzQryPrms(getAssetReg, "param1", Vnb2);
						...
						//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
								...
								//List<Object[]> listFixedAssetRegAll = (List<Object[]>) appConfig.findAllByMultiClzQryPrms(getFixedAssetReg, "param1", Vnb2);
					...
					//GR
					...
					else if(StringUtils.equalsIgnoreCase(VType2, "gr") && !StringUtils.equalsIgnoreCase(Vnb2, "") ) {
						...
						query.setParameter("param1", Vnb2);
						List<Object[]> listPurchReq = query.list();
						//List<Object[]> listPurchReq = (List<Object[]>) appConfig.findAllByMultiClzQryPrms(getPurchREq, "param1", Vnb2);
						...
						//List<Object[]> listPurchOrd = (List<Object[]>) appConfig.findAllByMultiClzQryPrms(getPurchOrd, "param1", Vnb2);
						...
						query.setParameter("param1", Vnb2);
						List<Object[]> listDiscovNew = query.list();
						//List<Object[]> listDiscovNew = (List<Object[]>) appConfig.findAllByMultiClzQryPrms(getDiscovNew, "param1", Vnb2);
						...
						query.setParameter("param1", Vnb2);
						List<Object[]> listCapitalAll = query.list();
						//List<Object[]> listCapitalAll = (List<Object[]>) appConfig.findAllByMultiClzQryPrms(getCapInProg, "param1", Vnb2);
						...
						query.setParameter("param1", Vnb2);
						List<Object[]> listAssetRegAll = query.list();
						//List<Object[]> listAssetRegAll = (List<Object[]>) appConfig.findAllByMultiClzQryPrms(getAssetRegAll, "param1", Vnb2);
						float arValRate = 0;
						...
						query.setParameter("param1", Vnb2);
						List<Object[]> listFixedAssetRegAll = query.list();
						//List<Object[]> listFixedAssetRegAll = (List<Object[]>) appConfig.findAllByMultiClzQryPrms(getFixedAssetRegAll, "param1", Vnb2);
	...
	if(StringUtils.equalsIgnoreCase(VType, "pr")) {
	     ...
	     q = session.createQuery("select ID ,' ' from PurchaseRequest where ID like :param1");
	...
	if (StringUtils.equalsIgnoreCase(VType, "po")) {
		 ...
		 requestName = "%" + request.getParameter("VoucherNb") + "%";
		  ...
		  q = session.createQuery("select ID ,' ' from PurchaseOrder where ID like :param1");
		  q.setString("param1", requestName);
		  q.setFirstResult(0);
		  q.setMaxResults(40);
		  listrequest = q.list();
	...
	if (StringUtils.equalsIgnoreCase(VType, "gr")) {
		 ...
		 requestName = "%" + request.getParameter("VoucherNb") + "%";
		  ...
		  q = session.createQuery("select ID ,' '  from GoodsReceived where ID like :param1");
		  q.setString("param1", requestName);
		  q.setFirstResult(0);
		  q.setMaxResults(40);
		  listrequest = q.list();
	...
	if (StringUtils.equalsIgnoreCase(VType, "ar")) {
		 ...
		 requestName = "%" + request.getParameter("VoucherNb") + "%";
		  ...
		  q = session.createQuery("select arID ,' '  from AssetRegistry where arID like :param1");
		  q.setString("param1", requestName);
		  q.setFirstResult(0);
		  q.setMaxResults(40);
		  listrequest = q.list();
	...
	if (StringUtils.equalsIgnoreCase(VType, "far")) {
		 ...
		 requestName = "%" + request.getParameter("VoucherNb") + "%";
		  ...
		  q = session.createQuery("select farID ,' '  from FixedAssetRegistry where farID like :param1");
		  q.setString("param1", requestName);
		  q.setFirstResult(0);
		  q.setMaxResults(40);
		  listrequest = q.list();
