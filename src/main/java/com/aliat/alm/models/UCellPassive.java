...
@Entity
@Table(name = "CELL_PASSIVE_3G")
public class UCellPassive {
    ...
    public UCellPassive(String id, String cellId, String dateOnAir, String cellName, String siteSubType, String antennaGain,
