...
@Entity
@Table(name="STRAND_AUXILIARY_POINTS")
public class StrandAuxPoints {
	...
	public StrandAuxPoints() {
		super();
		// TODO Auto-generated constructor stub
	}

	public StrandAuxPoints(String auxID, String fibercableID, String strandID, double l, double lat,
