...
@Entity
@Table(name = "WORK_ORDER_SOURCE_BOQ")
public class WorkOrderSourceBoq {
	...
	public  WorkOrderSourceBoq() {
		
		
	}

	public WorkOrderSourceBoq(String itemCode, String itemName, String itemModel, String itemPartNumber,
