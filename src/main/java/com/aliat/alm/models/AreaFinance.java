...
@Entity
@Table(name = "AREA_FINANCE")
public class AreaFinance {
	...
	public AreaFinance(String id, Timestamp creationDate, Timestamp lastModifyDate, Timestamp startDate, Timestamp endDate, String areaId, String areaName,
