...
public class Trench {
	...
	public Trench(String trenchID, String trenchName, String sourceWareId, String sourceId, String sourceName, String destinationWareId, String destinationId, String destinationName,
			String srcLong, String srcLat, String destLong, String destLat, String srcCity,
			String destCity, double numDucts, double maxCapacity, double length, String projectId,Timestamp creationDate, Timestamp lastModifieddate, String createdBy, 
