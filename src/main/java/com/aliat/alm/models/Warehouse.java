...
public class Warehouse {
	...
	public Warehouse(String wareID, Timestamp wcreationDate, Timestamp wlastModifieddate, String warehouseName,
			String wareCity, String wareLong, String wareLat, char wareSite, String wareSiteID, char tech2g,
			char tech3g, char tech4g, char tech5g, String areaID, String areaName, String clusterID, String clusterName,
			String address, String whStatus, String combtech, String regionID, String regionName, Integer population,
			String siteType, Integer unitCount, String unitBreakdown) {
		super();
		this.wareID = wareID;
		...
		this.unitBreakdown = unitBreakdown;
	}
	...
	public String getUnitBreakdown() {
		return unitBreakdown;
	}

	public void setUnitBreakDown(String unitBreakdown) {
		this.unitBreakdown = unitBreakdown;
	}
}