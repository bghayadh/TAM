...
@Entity
@Table(name = "SIM_TRANSACTION_BOQ")
public class SimTransactionBoq {
...
public SimTransactionBoq() {	
	
}

public SimTransactionBoq(String simTransactionItemID,String serMSI,
		String sourceType,String source,String sourceID,String sourceMSISDN,String destinationType,
		String destination,String destinationID,String transactionID,int totalQty, Timestamp creationDate,
		Timestamp lastModifieddate,String serial_obj) {
	super();
