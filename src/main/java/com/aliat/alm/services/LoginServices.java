	 ...
	 public String validate(String userName, String password, HttpServletResponse response, HttpServletRequest request,
		 ...
		 * Configuration cfg = new Configuration().configure();
			...
			try {
				...
				//Query q = session.createSQLQuery("select * from USERS_TABLE where USER_NAME= '"+userName+"'");
...
//	                    aapConfig.deleteRow(UserSession.class, httpSession.getAttribute("userName").toString());
