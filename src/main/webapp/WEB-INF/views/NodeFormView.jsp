                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="form-group">
							...
							Date</span> <input type=" text" id="wcreationDate" readonly value="${creation_date}"
                        ...
                        <div class="form-group">
                            <div class="input-group-prepend" id="datetimepicker2" data-target-input="nearest">
                                <span class="input-group-text" style="width: 210px;">Last
                                    ...
                                    value="${update_date}" class="form-control datetimepicker-input"
...
<div class="row">
  <div class="col-12 col-sm-12 col-lg-12">
    <div class="scrollable-list" style="width: 100%; background-color: #00757c; float: left; ">
      <ul class="nav nav-tabs" id="custom-tabs-one-tab-scroll" role="tablist" style="background-color: #00757c; display: flex; flex-wrap: nowrap;">
       <li class="tab" class="nav-item"><a class="nav-link active" id="custom-tabs-one-home-tab"
                            ...
                            <li class="nav-item"><a class="nav-link" id="custom-tabs-one-model-tab" data-toggle="tab"
                                    href="#custom-tabs-one-model" role="tab" aria-controls="custom-tabs-one-profile"
                                    aria-selected="false" style="color: gold;">MODULE</a></li>

                            <li class="nav-item"><a class="nav-link" id="custom-tabs-submodule-tab" data-toggle="tab"
                                    href="#custom-tabs-submodule" role="tab" aria-controls="#custom-tabs-one-submodule"
                                    aria-selected="false" style="color: gold;">SUBMODULE</a></li>
                            ...
                            <li class="nav-item"><a class="nav-link" id="custom-tabs-port-tab" data-toggle="tab"
                                    href="#custom-tabs-port" role="tab" aria-controls="custom-tabs-one-port"
                                    aria-selected="false" style="color: gold;">PORT</a>
                            </li>
                            ...
                            <li class="nav-item ml-auto" style="position: sticky; right: 0; opacity: 1; background-color: #00757c;" id="actionMenus">
...
<p></p>
            ...
            <div class="form-group">
                <div class="input-group-prepend">
                    <span class="input-group-text">Node Id</span>
                    <input type="text" id="nodeId" value="${node_id}" style="width:500px; height: 37px;" class="form-control text-input" readonly />
                </div>
            </div>
            </div>
        	<div class="col-md-4">
			...
			<div class="form-group">
				<div class="input-group-prepend">
					...
					<input type="text" id="warepname" value="${node_type}" class="form-control text-input" readonly />
				</div>
			</div>
			</div>
			...
			<div class="form-group">
				<div class="input-group-prepend">
					<span class="input-group-text">Node Model</span>
					<input type="text" id="warepname" value="${node_model}" class="form-control text-input" readonly />
				</div>
			</div>
			</div>
			...
			<div class="form-group">
				<div class="input-group-prepend">
					...
					<input type="text" id="warepname" value="${site_id}" class="form-control text-input" readonly />
				</div>
			</div>
			</div>
			</div>
			...
			<div class="form-group">
				...
				<input type="text" id="warepname" value="${ware_name}" class="form-control text-input" readonly />
				</div>
			</div>
			</div>
			...
			<div class="form-group">
				...
				<input type="text" id="warepname" value="${vendor}" class="form-control text-input" readonly />
				</div>
			</div>
			</div>
			...
			<div class="form-group">
				<div class="input-group-prepend">
					...
					<input type="text" id="warepname" value="${domain}" class="form-control text-input" readonly />
				</div>
			</div>
			</div>
			</div>
	...
	<div class="tab-pane fade" id="custom-tabs-one-pass" role="tabpanel" aria-labelledby="custom-tabs-one-pass-tab">
			...
			<div class="form-group">
				<div class="input-group-prepend">
					<span class="input-group-text">Passive PK</span>
					<input type="text" id="passivePk" value="${passivePk}" class="form-control text-input" readonly />
				</div>
			</div>
			</div>
			...
			<div class="form-group">
				<div class="input-group-prepend">
					<span class="input-group-text">Site Type</span>
					<input type="text" id="siteType" value="${siteType}" class="form-control text-input"/>
				</div>
			</div>
			</div>
			...
			<div class="form-group">
				...
				<input type="text" id="swap" value="${swap}" class="form-control text-input"/>
				</div>
			</div>
			</div>
			</div>
			...
			<div class="form-group">
				<div class="input-group-prepend">
				<span class="input-group-text">Swap Date</span>
				<input type="text" id="SwapDate" value="${swapDate}" class="form-control text-input"/>
				</div>
			</div>
			</div>
			...
			<div class="form-group">
				...
				<span class="input-group-text">Discovery Date</span>
				<input type="text" id="discoveryDate" value="${discoveryDate}" class="form-control datetimepicker-input"
			...
			<div class="form-group">
				...
				<span class="input-group-text">Last Shown Date</span>
				<input type="text" id="shownDate" value="${shownDate}" class="form-control datetimepicker-input"
				data-toggle="datetimepicker"  />
				<div class="input-group-append" data-toggle="datetimepicker" data-target="#datetimepicker9">
				<div class="input-group-text" data-target="#datetimepicker9"><i class="fa fa-calendar"></i></div>
				</div>
				</div>
			</div>
			</div>
			...
			<div class="form-group">
				...
				<input type="text" id="creationDate" value="${creationDate}"  class="form-control text-input" readonly/>
				</div>
			</div>
			</div>
			...
			<div class="form-group">
				...
				<input type="text" id="modifiedDate" value="${modifiedDate}"  class="form-control text-input" readonly/>
				</div>
			</div>                        
			</div>
			</div>
	...
	<table id="UCellTable" class="table table-striped table-bordered table-sm" style="display: block; height: 400px; overflow-y: auto;">
		<thead>
			<tr>
                        ...
                        <table id="LCellTable" class="table table-striped table-bordered table-sm"
                            style="display: block; height: 400px; overflow-y: auto;">
                            <thead>
                                <tr>
                                    <th>LCELL_ID</th>
                                    <th>LOCALCELLID</th>
                    ...
                    <div class="tab-pane fade" id="custom-tabs-one-model" role="tabpanel"
                        aria-labelledby="custom-tabs-one-model-tab">
                        <table id="ModuleTable" class="table table-striped table-bordered table-sm"
                    ...
                    <div class="tab-pane fade" id="custom-tabs-submodule" role="tabpanel"
                        aria-labelledby="custom-tabs-submodule-tab">
                        <table id="SubModuleTable" class="table table-striped table-bordered table-sm"
                    ...
                    <div class="tab-pane fade" id="custom-tabs-version" role="tabpanel"
                        ...
                        <table id="NodeHostTable" class="table table-striped table-bordered table-sm"
                            style="display:block; height:500px; overflow: auto;">
                            <thead>
                    ...
                    <div class="tab-pane fade" id="custom-tabs-antena" role="tabpanel"
                        ...
                        <table id="AntinnaTable" class="table table-striped table-bordered table-sm"
                    ...
                    <div class="tab-pane fade" id="custom-tabs-subrack" role="tabpanel"
                        ...
                        <table id="SubrackTable" class="table table-striped table-bordered table-sm"
                            style="display: block; height: 500px; overflow: auto;">
                            <tr>
                                <th>SUBRACK_ID</th>
                                <th>SITEINDEX</th>
                    ...
                    <div class="tab-pane fade" id="custom-tabs-board" role="tabpanel"
                        ...
                        <table id="BoardTable" class="table table-striped table-bordered table-sm"
                            style="display:block; height:500px; overflow: auto;">
                            <thead>
                                <tr class="fixed-headerr">
                                    <th>Board Id</th>
                    ...
                    <div class="tab-pane fade" id="custom-tabs-cabinat" role="tabpanel"
                        ...
                        <table id="CabinatTable" class="table table-striped table-bordered table-sm"
                            style="display:block; height:500px; overflow: auto;">
                            <thead>
                                <tr class="fixed-headerr">
                                    <th>CABINET_ID</th>
        ...
        if (status == "old") {
            ...
            for (i = 0; i < BoqArray.length; i++) {
                c = "<tr>" +
                    ...
                    "<td ><input  type='text'  value='" + BoqArray[i][20] + "' style='width:190px;' class='form-control text-input' readonly/></td>" +
                    "<td ><input  type='text'  value='" + BoqArray[i][21] + "' style='width:190px;' class='form-control text-input' readonly/></td>" +
                    "<td ><input  type='text'  value='" + BoqArray[i][22] + "' style='width:190px;' class='form-control text-input' readonly/></td></tr>";
