			...
			<div class="col-12 col-sm-12 col-lg-12">
				<ul class="nav nav-tabs" id="custom-tabs-one-tab" role="tablist"
					...
					<li class="nav-item" class="nav-link inactive"
						...
						style="color: gold; center; line-height: 2.75em; padding-left: 5px;">PATCHING WORK
						ORDER TASK LIST</li>
					...
					<li class="nav-item ml-auto">
						...
						<button type="button" id="saveButton"
							onclick='window.location.href = "${pageContext.request.contextPath}/PatchingWorkOrderTaskFormView?type=addNew"'
							class="btn btn-primary BtnActive">
...
<script>
	...
	var ReportArrayGlobal = ${WorkOrderTaskDt};
...
//////////////////////////////////////////////////////////////////////////export button
							...
							var deleteArray = [];
								$("#gridTable").find(".table-select-checkbox").each(function() {
										if ($(this).is(":checked")) {
											...
											$.ajax({
														type : "GET",
														url : "${pageContext.request.contextPath}/WoTaskListDelete",
														dataType : "json",
														data : {
															"workOrdTaskId" : deleteArray
														},
						...
						$(".almgrid-table").on("click",".almgrid-link",function(e) {
											...
											var param = "${pageContext.request.contextPath}/PatchingWorkOrderTaskFormView?workOrdTaskId="+ param1+ "&NavAction=2";
						...
						$('#Fview').click(function(e) {
							 ...
							 var param = "${pageContext.request.contextPath}/PatchingWorkOrderTaskFormView?type=addNew";
							 window.location.href = param;
							 e.preventDefault();
							 }
						       ...
						       var param = "${pageContext.request.contextPath}/PatchingWorkOrderTaskFormView?workOrdTaskId=" + firstCell+"&NavAction=2";
							   window.location.href = param;
							   e.preventDefault();
							  }
