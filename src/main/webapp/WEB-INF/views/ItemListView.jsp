				...
				<div class="row second">
					...
					<div class="col-md-3" style="text-align: right;">
						<div class="btn-group pull-right">
							...
							<button type="button" id="searchItem" class="btn btn-light" data-toggle="tooltip" data-placement="top"
									title="Search">
...
<div class="modal-footer">
	...
	<button type="button" id="popUpCancel" class ="btn btn-default btn-primary BtnActive" style="color:white;position:relative;">Cancel</button>
						...
						<ul class="nav nav-tabs" id="custom-tabs-one-tab" role="tablist"
							...
							<li class="nav-item">
								<class="nav-link inactive" id="custom-tabs-one-home-tab"
									style="color: gold;text-align:center;line-height:2.75em; padding-left:5px;">ITEM
									LIST
							</li>
							...
							<li class="nav-item ml-auto">
								...
								<button type="button" id="saveButton"
									onclick='window.location.href = "${pageContext.request.contextPath}/ItemFormView?type=addNew"'
					...
					<div class="row">
						<div class="col-sm-12">
							<div class="almgrid-container">
								...
								<div id="itemgridtable"class="table-responsive almgrid-table-div">
			...
			<script>
				...
				var itemListData = ${ ListGridTable };
			...
			/*		// TO READ FROM DATABASE
					$.each(itemListData, function (i, value) {
...
//								alert("checkboxVal is " +checkboxVal);
							}
...
download_link.download = "Item_List_Export";
...
exportArrayGrid.push(["Item Code", "Name", "Model", "Part Number","Last Modified Date"]);
...
//location.reload();
	...
	$("#searchItem").click(function() {
		$("#poModal").modal("show");
		document.getElementById('searchItem').className = 'btn btn-danger';
 	document.getElementById('Lview').className = 'btn btn-light';
 	$("#Lview").css('background', '#FFFFFF');	
		$("#searchItem").css('background', '#da6815');	
	...
	$("#popUpSubmit").click(function() {
		$("#poModal").modal("show");
		$("#gridTable").remove();
		$("#itemgridtable").append('<table id="gridTable" class="table table-striped table-bordered almgrid-table"><thead>'
				+'<tr class="header">'
				...
				+'<ul class="dropdown-menu filter-dropdown-ul"></ul></li></th>'
				+'<th>Model<li class="filter-dropdown dropdown"><button class="almgrid-filter" data-toggle="dropdown"><i class="fa fa-list almgrid-filter-i" aria-hidden="true"></i></button>'
				+'<ul class="dropdown-menu filter-dropdown-ul"></ul></li></th>'
				+'<th>Part Number<li class="filter-dropdown dropdown"><button class="almgrid-filter" data-toggle="dropdown"><i class="fa fa-list almgrid-filter-i" aria-hidden="true"></i></button>'
		...
		url : "${pageContext.request.contextPath}/FilteredItemListView",
...
//{$("#popupstartdate").val('');$("#popupenddate").val('');$("#popupitemcode").val('');$("#popupitemname").val('');$("#popupitemmodel").val('');}
					...
					$(".almgrid-table").on("click", ".almgrid-link", function (e) {
						var param1 = $(this).attr('id');
						var param = "${pageContext.request.contextPath}/ItemFormView?itemcode=" + param1+"&NavAction=2";
						window.location.href = param;
						e.preventDefault();
					});
					 ...
					 var param = "${pageContext.request.contextPath}/ItemFormView&NavAction=2";
					 window.location.href = param;
					 e.preventDefault();
					 }
				     ...
				     var param = "${pageContext.request.contextPath}/ItemFormView?itemcode=" + firstCell+"&itemsList=itemsList&NavAction=2";
					 window.location.href = param;
					 e.preventDefault();
					 }
