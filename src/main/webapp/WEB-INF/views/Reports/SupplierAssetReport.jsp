...
<title>Supplier Asset Report</title>
...
<script type="text/javascript"
	src="${pageContext.request.contextPath}/resources/almgrid/gridAppendRows.js"></script>
			...
			<div class="col-md-2" style="display: flex; ">
				<div class="form-group "style="margin-left: 15px; ">
					<div class="input-group-prepend">
						<span class="input-group-text" style="color: green">Supplier Asset Report</span>
					</div>
				</div>
			</div>
			<div class="col-md-3">
	  ...
	  $
		.ajax({
			...
			success : function(data) {
				console.log(data.SupplierAssetReportGrid.length);
				if (data.SupplierAssetReportGrid.length == 0) {
...
var exportArrayGrid = [];
	...
	function fillGrid(filledGrid) {
		...
		var data = [];
		data.push('\r');
		data.push([ "Supplier ID","Supplier Name","Initial Cost","Net Cost","Accumulated Depreciation" ]);
