			...
			<div class="col-md-4">
				<div class="form-group">
					<div class="input-group-prepend">
						...
						<input readonly type="text" id="totalCables" class="form-control text-input" style="width:120px;"/>
					</div>
				</div>
		</div>
		<div class="col-md-4">
		...
		<div class="col-md-4">
			<div class="form-group">
				<div class="input-group-prepend">
					...
					<input readonly type="text" id="geoDistance" class="form-control text-input" style="width:120px;" />
				</div>
			</div>
		</div>
