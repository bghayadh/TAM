...
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/resources/css/Network_Index.css">
...
<script
	src="${pageContext.request.contextPath}/resources/js/Network/BordersFindNearest.js"></script>
			...
			<div class="row second">
				...
				<div class="col-md-3">
					<div class="form-group">
						<div class="input-group-prepend">
							<span class="input-group-text">Fiber Cable</span> <input
								type="text" id="fiberCable" class="form-control text-input"
								style="width: 300px;" />
						</div>
					</div>
				</div>
				...
				<div class="col-md-2">
					<button type="button" id="showOnMap" class="btn mapButtons"
						style="margin-left: 50px;" onclick="showOnMap()">Show on
						Map</button>
				</div>
									...
									<div style="display: Block;" id="totalStrandsNums">
										<div class="row second" style="padding-left: 15px;">
												...
												<div class="form-group">
													<div class="input-group-prepend">
														<span class="input-group-text">Total Number of
															Strands</span> <input readonly type="text" id="totalStrands"
											...
											<div class="col-md-4">
												<div class="form-group">
													<div class="input-group-prepend">
														<span class="input-group-text">Total Used Strands</span> <input
															readonly type="text" id="totalUsedStrands"
															class="form-control text-input" style="width: 120px;" />
													</div>
												</div>
											</div>
											<div class="col-md-4">
												<div class="form-group">
													<div class="input-group-prepend">
														<span class="input-group-text">Total Not Used
															Strands</span> <input readonly type="text"
															id="totalNotUsedStrands" class="form-control text-input"
															style="width: 120px;" />
													</div>
												</div>
											</div>
									...
									<div class="legendContainer">
										<div class="card-body">
											<div class="box stack-top" id="legendDiv"
												style="position: relative; bottom: 50px; width: 290px; float: left; height: 570px; background: white; margin: 37px; display: none">
													...
													<table id="strandUtilizationTableReport">
														...
														<tr>
															<td style="position: relative; left: 37px;"><input
																...
																class="showHideCableCheckbox" onclick="showHideCable();"
																value="blue" /></td>
															<td style="position: relative; top: 10px; left: 62px;"><div>
																	<img class='image' style='color: #08526D;'
																		src='${pageContext.request.contextPath}/resources/NetworkImages/fiber.png'>
																</div></td>
															<td style="position: relative; top: 8px; left: 65px;"><label
																style="color: black; font-weight: bold; font-size: 2ex;">Fiber
																	Cable</label></td>
															<td style="position: relative; top: 8px; left: 65px;"><div
																	style="position: relative; left: -5px; color: black;"
																	id="fiberCount"></div></td>
														</tr>
														<tr>
															<td style="position: relative; left: 37px;"><input
																style="position: relative; top: 11px;" type="checkbox"
																name="legendCheckbox" disabled
																class="showHideRelatedCableCheckbox"
																onclick="showCableRelatedPath();" /></td>
															<td style="position: relative; top: 10px; left: 62px;"><div>
																	<img class='image' style='color: #08526D;'
																		src='${pageContext.request.contextPath}/resources/NetworkImages/fiber.png'>
																</div></td>
															<td style="position: relative; top: 8px; left: 65px;"><label
																style="color: black; font-weight: bold; font-size: 2ex;">Show
																	Related Path</label></td>
															<td style="position: relative; top: 8px; left: 65px;"><div
																	style="position: relative; left: -5px; color: black;"
																	id="relatedPathCount"></div></td>
														</tr>
														...
														<tr>
															<td style="position: relative; left: 37px;"><input
																style="position: relative; top: 11px;" type="checkbox"
																name="legendCheckbox" disabled
																class="showHideAllManholesCheckbox"
																onclick="showHidePts('showHideAllManholesCheckbox');"
																value="red" /></td>
															<td style="position: relative; top: 8px; left: 62px;"><div>
																	<img class='image'
																		src='${pageContext.request.contextPath}/resources/NetworkImages/manholeRed.png'>
																</div></td>
															<td style="position: relative; top: 8px; left: 65px;"><label
																style="color: black; font-weight: bold; font-size: 2ex;">Manhole</label></td>
															<td style="position: relative; top: 8px;"><div
																	style="position: relative; left: -5px; color: black;"
																	id="manholesCount"></div></td>
														</tr>
														...
														<tr>
															<td style="position: relative; left: 37px;"><input
																style="position: relative; top: 11px;" type="checkbox"
																name="legendCheckbox" disabled
																class="showHideAllManholesWithJctCheckbox"
																onclick="showHidePts('showHideAllManholesWithJctCheckbox');"
																value="red" /></td>
															<td style="position: relative; top: 8px; left: 62px;"><div>
																	<img class='image'
																		src='${pageContext.request.contextPath}/resources/NetworkImages/manholeJct.png'>
																</div></td>
															<td style="position: relative; top: 8px; left: 65px;"><label
																style="color: black; font-weight: bold; font-size: 2ex;">Manhole
																	with JCT</label></td>
															<td style="position: relative; top: 8px; left: 65px;"><div
																	style="position: relative; left: -5px; color: black;"
																	id="manholesCountWithJct"></div></td>
														</tr>
														...
														<tr>
															<td style="position: relative; left: 37px;"><input
																style="position: relative; top: 11px;" type="checkbox"
																name="legendCheckbox" disabled
																class="showHideAllHandholesCheckbox"
																onclick="showHidePts('showHideAllHandholesCheckbox');"
																value="yellow" /></td>
															<td style="position: relative; top: 8px; left: 62px;"><div>
																	<img class='image'
																		src='${pageContext.request.contextPath}/resources/NetworkImages/handholeYellow.png'>
																</div></td>
															<td style="position: relative; top: 8px; left: 65px;"><label
																style="color: black; font-weight: bold; font-size: 2ex;">Handhole</label></td>
															<td style="position: relative; top: 8px;"><div
																	style="position: relative; left: -5px; color: black;"
																	id="handholesCount"></div></td>
														</tr>
														<tr>
															<td style="position: relative; left: 37px;"><input
																style="position: relative; top: 11px;" type="checkbox"
																name="legendCheckbox" disabled
																class="showHideAllHandholesWithJctCheckbox"
																onclick="showHidePts('showHideAllHandholesWithJctCheckbox');"
																value="yellow" /></td>
															<td style="position: relative; top: 8px; left: 62px;"><div>
																	<img class='image'
																		src='${pageContext.request.contextPath}/resources/NetworkImages/handholeYellowJct.png'>
																</div></td>
															<td style="position: relative; top: 8px; left: 65px;"><label
																style="color: black; font-weight: bold; font-size: 2ex;">Handhole
																	with JCT</label></td>
															<td style="position: relative; top: 8px; left: 65px;"><div
																	style="position: relative; left: -5px; color: black;"
																	id="handholesCountWithJct"></div></td>
														</tr>
														...
														<tr>
															<td style="position: relative; left: 37px;"><input
																style="position: relative; top: 11px;" type="checkbox"
																name="legendCheckbox" disabled
																class="showHideAllDbCheckbox"
																onclick="showHidePts('showHideAllDbCheckbox');"
																value="blue" /></td>
															<td style="position: relative; top: 8px; left: 62px;"><div>
																	<img class='image'
																		src='${pageContext.request.contextPath}/resources/NetworkImages/backboneDB.png'>
																</div></td>
															<td style="position: relative; top: 8px; left: 65px;"><label
																style="color: black; font-weight: bold; font-size: 2ex;">DB</label></td>
															<td style="position: relative; top: 8px;"><div
																	style="position: relative; left: -5px; color: black;"
																	id="dbCount"></div></td>
														</tr>
														<tr>
															<td style="position: relative; left: 37px;"><input
																style="position: relative; top: 11px;" type="checkbox"
																name="legendCheckbox" disabled
																class="showHideAllJctCheckbox"
																onclick="showHidePts('showHideAllJctCheckbox');"
																value="orange" /></td>
															<td style="position: relative; top: 8px; left: 58px;"><div>
																	<img class='image'
																		src='${pageContext.request.contextPath}/resources/NetworkImages/junctionOrange.png'>
																</div></td>
															<td style="position: relative; top: 8px; left: 65px;"><label
																style="color: black; font-weight: bold; font-size: 2ex;">Junction</label></td>
															<td style="position: relative; top: 8px;"><div
																	style="position: relative; left: -5px; color: black;"
																	id="jctCount"></div></td>
														</tr>
														...
														<tr>
															<td style="position: relative; left: 37px;"><input
																style="position: relative; top: 11px;" type="checkbox"
																name="legendCheckbox" disabled
																class="showHideSrcCheckbox"
																onclick="showHideSourceMarker();" value="pink" /></td>
															<td style="position: relative; top: 8px; left: 58px;"><div>
																	<img class='image' style="width: 25px; height: 30px;"
																		src='${pageContext.request.contextPath}/resources/NetworkImages/SrcDest.png'>
																</div></td>
															<td style="position: relative; top: 8px; left: 65px;"><label
																style="color: black; font-weight: bold; font-size: 2ex;">Source</label></td>
														</tr>
														<tr>
															<td style="position: relative; left: 37px;"><input
																style="position: relative; top: 11px;" type="checkbox"
																name="legendCheckbox" disabled
																class="showHideDstCheckbox"
																onclick="showHideDestinationMarker();" value="pink" /></td>
															<td style="position: relative; top: 8px; left: 58px;"><div>
																	<img class='image' style="width: 25px; height: 30px;"
																		src='${pageContext.request.contextPath}/resources/NetworkImages/SrcDest.png'>
																</div></td>
															<td style="position: relative; top: 8px; left: 65px;"><label
																style="color: black; font-weight: bold; font-size: 2ex;">Destination</label></td>
														</tr>
