...
<title>Strand Utilization Report</title>
     <link rel="shortcut icon" href="">
		...
		<script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/Reports/strand-utilization/gridAppendRowsStrandUtilizationReport.js"></script>		
        ...
        <script src="${pageContext.request.contextPath}/resources/js/Reports/strand-utilization/strand-utilization-init.js"></script>
        <script src="${pageContext.request.contextPath}/resources/js/Reports/strand-utilization/strand-utilization-autocomplete.js"></script>
        <script src="${pageContext.request.contextPath}/resources/js/Reports/strand-utilization/strand-utilization-events.js"></script>
        <script src="${pageContext.request.contextPath}/resources/js/Reports/strand-utilization/strand-utilization-export.js"></script>
        <script src="${pageContext.request.contextPath}/resources/js/Reports/strand-utilization/strand-utilization-ui.js"></script>
        <script src="${pageContext.request.contextPath}/resources/js/Reports/strand-utilization/strand-utilization-generate.js"></script>
        <script src="${pageContext.request.contextPath}/resources/js/Reports/strand-utilization/strand-utilization-grid.js"></script>
        <script src="${pageContext.request.contextPath}/resources/js/Reports/strand-utilization/strand-utilization-legend.js"></script>
        <script src="${pageContext.request.contextPath}/resources/js/Reports/strand-utilization/strand-utilization-map.js"></script>
        <script src="${pageContext.request.contextPath}/resources/js/Reports/strand-utilization/strand-utilization-show-on-map.js"></script>
