					...
					<div class="panel-heading" role="tab" id="headingOne">
						<h4 class="panel-title">
							<a role="button" data-toggle="collapse" data-parent="#accordion"
								...
								aria-controls="collapseOne"> GIS </a>
						</h4>
					</div>
				...
				<div class="panel-heading " role="tab" id="headingTwo">
					<h4 class="panel-title">
						<a role="button" data-toggle="collapse" data-parent="#accordion"
							...
							aria-controls="collapseTwo"> Grid Table </a>
					</h4>
				</div>
								...
								<div class="col-sm-12">
									<div class="almgrid-container">
										...
										<div id="alertMsgDiv"
											...
											<br> <b
												style="color: red; font-size: 15px; white-space: nowrap;">The
												number of original fetched data is exceeding the number of
												allowed data to show. Please set a filter to reduce the
												fetched data.</b>
										</div>
											...
											$
													.ajax({
														...
														success : function(data) {
															console
																	.log(data.TransactionsGrid.length);
