...
<body>
  ...
  <jsp:include page="../header.jsp"></jsp:include>
	...
	<div Style=" left: 0; bottom: 0;" id="SiteAssetReportDiv">
			...
			<div class="col-md-2" style="display: flex; ">
				<div class="form-group "style="margin-left: 15px; ">
					<div class="input-group-prepend">
						<span class="input-group-text" style="color: green">Site Asset Report</span>
					</div>
				</div>
			</div>
			<div class="col-md-3">
...
$(document).ready(function() {
    ...
    var ReportArrayGlobal = ${siteAssetReportList};
        ...
        drawTableGrid :  function (tableId, dataArray) {
	        ...
	        if (dataArray.length > 0) {
        		...
        		var columnVal;
	     	    ...
	     	    exportArrayGrid = [];
	    		data.push('\r');
	       		data.push(["Warehouse ID","Site ID","Site Name","Longitude","Latitude","Initial Cost","Net Cost","Accumulated Depreciation"]);
    ...
    circleRangeCheckbox.change(function() {
	  ...
	  $("#generate").click(function() {
		...
		$.ajax({
			...
			url : "${pageContext.request.contextPath}/GenerateGridSiteAssetReport",
			dataType : "json",
			data : {
  ...
  error : function(error) {
		...
		$("#SiteAssetReportDiv").on('click', function(){
			HideContextMenuGoolge(MenuMap);
		});
