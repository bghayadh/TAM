...
<head>
<meta charset="utf-8">
    <title>Activity List View</title>
...
<%-- 	<%@ include file="header.html" %> --%>
  <c:set var="pg" value="Activity" scope="session"  />
						...
						<ul class="nav nav-tabs" id="custom-tabs-one-tab" role="tablist"
							...
							<li class="nav-item">
								<class="nav-link inactive" id="custom-tabs-one-home-tab"
									style="color: gold;text-align:center;line-height:2.75em; padding-left:5px;">ACTIVITY LIST VIEW
...
<!--------------------------------------------------  END card-header ------------------------------------------>
								...
								<div id="purchaseOrderGridTable" class="table-responsive almgrid-table-div">
									<table id="ActivityListTable" class="table table-striped table-bordered almgrid-table">
										<thead>
											<tr class="header">
...
var ActivityListData = ${ ListGridTable };
...
//method to export the data into excel sheet
	function exportGrid() {
		...
		download_link.download = "Activity_List_Export";
