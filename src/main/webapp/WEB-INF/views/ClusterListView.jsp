		 		...
		 		<div class="btn-group pull-right">
		 			<div class="glyph">
			 			<button  type="button" id="Fview"  class="btn btn-light" data-toggle="tooltip" 
			 				data-placement="top" title="Form View"  onclick='window.location.href = "${pageContext.request.contextPath}/ClusterFormView"'> <i class="fa fa-edit"></i>
			        	</button>
	...
	<p></p>
		...
		<div class="col-12 col-sm-12 col-lg-12">	
		      <ul class="nav nav-tabs" id="custom-tabs-one-tab" role="tablist" style="background-color: #007b7c; margin-top: 0px;">
		             <li class="nav-item"><class="nav-link inactive" id="custom-tabs-one-home-tab"  style="color: gold;center;line-height:2.75em; padding-left:5px;"> CLUSTER LIST</li>
		            ...
		            <li class="nav-item ml-auto">
						...
						<button type="button" id="saveButton" onclick='window.location.href = "${pageContext.request.contextPath}/ClusterFormView?type=addNew"'
						class="btn btn-primary BtnActive">
...
function setupStorage(browser){
	...
	if(browser == setArray){
			localStorage.setItem("clusterList", JSON.stringify(navigateArray));
			var param ="${pageContext.request.contextPath}/ClusterFormView?clusterID="+param1+"&NavAction=2";
