...
<%-- 		<%@ include file="header.html" %> --%>
  ...
  <jsp:include page="${request.contextPath}/headerController"></jsp:include>
						...
						<ul class="nav nav-tabs" id="custom-tabs-one-tab" role="tablist"
							...
							<li class="nav-item">
								<class="nav-link inactive" id="custom-tabs-one-home-tab"
									style="color: gold;text-align:center;line-height:2.75em; padding-left:5px;">Schedule
									LIST
							</li>
							...
							<li class="nav-item ml-auto">
								...
								<button type="button" id="saveButton"
									onclick='window.location.href = "${pageContext.request.contextPath}/ScheduleReportFormView?type=addNew"'
			...
			<script>
				...
				var scheduleListData = ${ ListGridTable };
				...
				$(document).ready(function () {
					...
					$.each(scheduleListData, function (i, value) {
					...
					$("#deleteButton").click(function () {
						...
						$.ajax({
							type: "GET",
							url: "${pageContext.request.contextPath}/ScheduleListViewDelete",
							dataType: "json",
							data: {
								"RuleId": deleteArray
							},
					...
					$(".almgrid-table").on("click", ".almgrid-link", function (e) {
						...
						var param = "${pageContext.request.contextPath}/ScheduleReportFormView?AreaID=" + param1+"&scheduleList=scheduleList";
						...
						e.preventDefault();
						 ...
						 var param = "${pageContext.request.contextPath}/ScheduleReportFormView";
						 window.location.href = param;
						 e.preventDefault();
						 }
					     ...
					     var param = "${pageContext.request.contextPath}/ScheduleReportFormView?RuleID=" + firstCell+"&scheduleList=scheduleList";
						 window.location.href = param;
						 e.preventDefault();
						 }
