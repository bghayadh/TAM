...
$(document).ready(function() {
	...
	"bProcessing": true,
    "aaData": roleList,// <-- your array of objects
    "aoColumns":[
    	{
        	"mData": null,
          	"bSortable": false,
	        "mRender" : function ( roleList, type, full ) { 
        ...
        
        {
           ...
           // how to pass parameter to UserFormView
            	//return    '<a href="'+ '${pageContext.request.contextPath}/UserRoleFormView?rolename='+full[1]'">';
            	//return    '<a href="'+ '${pageContext.request.contextPath}/UserRoleFormView?rolename='+full[1] '">' + url + '</a>';
            	return    '<a href="'+ '${pageContext.request.contextPath}/UserRoleFormView?rolename='+full[1] +'">'+ url + '</a>';
				}
