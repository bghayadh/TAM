 ...
 <jsp:include page="header.jsp"></jsp:include>
		...
		<div class="col-12 col-sm-12 col-lg-12">	
		      <ul class="nav nav-tabs" id="custom-tabs-one-tab" role="tablist" style="background-color: #007b7c; margin-right:0px">
		             <li class="nav-item"><class="nav-link inactive" id="custom-tabs-one-home-tab"  style="color: gold;text-align:center; font-size: 25px; margin: 10px">Role List</li>
		            ...
		            <li class="nav-item ml-auto">
						...
						<button type="button" id="saveButton" onclick='window.location.href = "${pageContext.request.contextPath}/UserRoleFormView?type=addNew"'
						class="btn btn-primary BtnActive">
					...
					<div class="row">
						<div class="col-sm-12">
							<div class="almgrid-container">
								...
								<div id="RoleUsersGridTable" class="table-responsive almgrid-table-div">
									<table id="RoleUsersTable" class="table table-striped table-bordered almgrid-table">
										<thead>
											<tr class="header">
...
<script>
    $(document).ready(function () {
        var UserRoleData = ${ListGridTable};
        ...
        $(".almgrid-table").on("click", ".almgrid-link", function (e) {
            ...
            var param = "${pageContext.request.contextPath}/UserRoleFormView?rolename=" + param1 + "&NavAction=2";
        ...
        $("#deleteButton").click(function () {
            var deleteArray = [];
            $("#RoleUsersTable").find(".table-select-checkbox").each(function () {
                if ($(this).is(":checked")) {
            ...
            $.ajax({
                type: "GET",
                url: "${pageContext.request.contextPath}/RoleListViewDelete",
                dataType: "json",
                data: {
                    "rolename": deleteArray
                },
    ...
    $( "#Fview" ).click(function() {
		var id =  $(".almgrid-link").closest('tr').find('td:first-child input').val();
			location.href="${pageContext.request.contextPath}/UserRoleFormView?rolename="+id+"&NavAction=2";
	});
