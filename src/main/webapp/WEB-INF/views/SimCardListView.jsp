  ...
  <jsp:include page="${request.contextPath}/headerController"></jsp:include>
						...
						<ul class="nav nav-tabs" id="custom-tabs-one-tab" role="tablist"
							...
							<li class="nav-item">
								<class="nav-link inactive" id="custom-tabs-one-home-tab"
									style="color: gold;text-align:center;line-height:2.75em; padding-left:5px;">SIM CARD LIST</li>
							...
							<li class="nav-item ml-auto">
								...
								<button type="button" id="saveButton"
									onclick='window.location.href = "${pageContext.request.contextPath}/SimCardFormView?type=addNew"'
			...
			<script>
				...
				$(document).ready(function () {
					...
					$.each(SimListData, function (i, value) {
						SimArrayGlobal.push({
					...
					$(".almgrid-table").on("click", ".almgrid-link", function (e) {
						...
						var param = "${pageContext.request.contextPath}/SimCardFormView?simId=" + param1+"&NavAction=2";
						...
						e.preventDefault();
						 ...
						 if (SimArrayGlobal.length == 0) {

						 var param = "${pageContext.request.contextPath}/SimCardFormView&NavAction=2";
						 window.location.href = param;
						 e.preventDefault();
						 }
					     ...
					     var param = "${pageContext.request.contextPath}/SimCardFormView?simId=" + firstCell+"&NavAction=2";
						 window.location.href = param;
						 e.preventDefault();
						 }
