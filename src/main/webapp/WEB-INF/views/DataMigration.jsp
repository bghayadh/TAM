								...
								<div class="card bg-light mb-3 mx-auto ">
									<div class="card-header Cardheader">
										<div class="row">
											...
											<div class="col-sm-10">
												<button class="button3" id="AccDepLineChart"
													style="align: center; margin-left: 20px;">Line
													Chart</button>
											</div>
										</div>
									</div>
								...
								<div class="card bg-light mb-3 mx-auto ">
									<div class="card-header Cardheader">
										<div class="row">
											...
											<div class="col-sm-10">
												<button class="button3" id="CalculateDepreciation"
													style="align: center; margin-left: 20px;">Calculate
													Depreciation</button>
											</div>
										</div>
									</div>
								...
								<div class="card bg-light mb-3 mx-auto ">
									<div class="card-header Cardheader">
										<div class="row">
											...
											<div class="col-sm-10">
												<button class="button3" id="sitesmigration"
													style="align: center; margin-left: 20px;">Sites
													Migration</button>
											</div>
										</div>
									</div>
								...
								<div class="card bg-light mb-3 mx-auto ">
									<div class="card-header Cardheader">
										<div class="row">
											...
											<div class="col-sm-10">
												<button class="button3" id="revenuemigration"
													style="align: center; margin-left: 20px; width: 300px;">Prepaid
													PayG Revenue Migration</button>
											</div>
										</div>
									</div>
									<div class="card-body mycard CardBody">
							...
							<div class="mx-auto cardsClass">
								<div class="card bg-light mb-3 mx-auto ">
									<div class="card-header Cardheader">
										<div class="row">
											<div class="col-sm-10">
												<button class="button3" id="runManholeScript"
													style="align: center; margin-left: 20px;">Manhole</button>
											</div>
										</div>
									</div>
									<div class="card-body mycard CardBody">
								...
								<div class="card bg-light mb-3 mx-auto ">
									<div class="card-header Cardheader">
										<div class="row">
											...
											<div class="col-sm-10">
												<button class="button3" id="runHandholeScript"
													style="align: center; margin-left: 20px;">Handhole</button>
											</div>
										</div>
									</div>
									<div class="card-body mycard CardBody">
							...
							<div class="mx-auto cardsClass">
								<div class="card bg-light mb-3 mx-auto ">
									<div class="card-header Cardheader">
										<div class="row">
											<div class="col-sm-10">
												<button class="button3" id="runAuxCableScript"
													style="align: center; margin-left: 20px;">Fiber
													Auxiliary Points</button>
											</div>
										</div>
									</div>
									<div class="card-body mycard CardBody">
								...
								<div class="card bg-light mb-3 mx-auto ">
									<div class="card-header Cardheader">
										<div class="row">
											...
											<div class="col-sm-10">
												<button class="button3" id="runFiberCableScript"
													style="align: center; margin-left: 20px;">Fiber
													Cable</button>
											</div>
										</div>
							...
							<div class="mx-auto cardsClass">
								<div class="card bg-light mb-3 mx-auto ">
									<div class="card-header Cardheader">
										<div class="row">
											<div class="col-sm-12">
												<button class="button3" id="runDbPortMapKSA_Salam"
													style="align: center;">DB Port Mapping - KSA - SALAM</button>
											</div>
										</div>
									</div>
									<div class="card-body mycard CardBody">
										<div id="loadingDbPortMapKSA_SalamMessage" class="loadingmsg">
											<img
												src="${pageContext.request.contextPath}/resources/images/ajax-loader.gif">
										</div>
										<div id="loadingAuxCableResult" class="loadingRes"></div>
...
<script type="text/javascript">
					...
					function() {
						...
						$
								.ajax({
									...
									success : function(data) {
										$('#loadingmessagemigrationrevenue')
												.hide();
										$("#loadingResultMigrationRevenue")
												.html(data.Result);
										console.log("Success Result");
									},
									error : function(error) {
										console
												.log("Failure in returning data ");
									}
								});
	...
	$("#runDbPortMapKSA_Salam").click(function() {
		$('#loadingDbPortMapKSA_SalamMessage').show();
		$.ajax({
			type : "GET",
			url : '${pageContext.request.contextPath}/insertDbPorts_KSA_Salam',
			contentType : "application/json",
			dataType : "json",
			data : {},
			success : function(data) {
				$('#loadingDbPortMapKSA_SalamMessage').hide();
				//$("#loadingResultMigrationRevenue").html(data.Result);
				console.log("The result is: ", data.Result);
				console.log("TotalPortsInserted is: ", data.TotalPortsInserted);
			},
			error : function(error) {
				console.log("Failure in returning data ");
			}
