...
<%-- 		<script src="${pageContext.request.contextPath}/resources/js/tableHTMLExport.js"></script> --%>
 ...
 <jsp:include page="header.jsp"></jsp:include>
						...
						<ul class="nav nav-tabs" id="custom-tabs-one-tab" role="tablist"
							...
							<li class="nav-item">
								<class="nav-link inactive" id="custom-tabs-one-home-tab"
									style="color: gold;text-align:center;line-height:2.75em; padding-left:5px;">SIM
						TRANSACTION LIST</li>
			...
			<script>
				...
				var transactionListData = ${ ListGridTable };
				...
				$(document).ready(function () {
					...
					$.each(transactionListData, function (i, value) {
						ArrayGlobal.push({
					...
					$("#deleteButton").click(function () {
						...
						$.ajax({
							type: "GET",
							url: "${pageContext.request.contextPath}/SimTransactionListViewDelete",
							dataType: "json",
							data: {
								"ID[]": deleteArray
							},
					...
					$(".almgrid-table").on("click", ".almgrid-link", function (e) {
						...
						var param = "${pageContext.request.contextPath}/SimTransactionFormView?transactionID=" + param1+"&NavAction=2";
						...
						e.preventDefault();
						 ...
						 var param = "${pageContext.request.contextPath}/SimTransactionFormView"+"&NavAction=2";
						 window.location.href = param;
						 e.preventDefault();
						 }
					     ...
					     var param = "${pageContext.request.contextPath}/SimTransactionFormView?transactionID=" + firstCell+"&NavAction=2";
						 window.location.href = param;
						 e.preventDefault();
						 }
