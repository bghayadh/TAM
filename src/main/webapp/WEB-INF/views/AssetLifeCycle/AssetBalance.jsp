	...
	$("#generate").click(  function() {
		 ...
		 if (element.innerHTML == "Select All"){
		 	...
		 	$.ajax({
					type : "GET",
					contentType: "application/json; charset=utf-8",
					url : "${pageContext.request.contextPath}/GenerateBalanceReport",
					dataType : "json",
					data : {
					...
					success : function(data) {
						 if (data != null) {
	                         var boqArray = [];
	         	     	    ...
	         	     	    boqArray = data.assetLifeCycleBalanceList;
	         	     	    ...
	         	     	    var ReportArrayGlobal = [];
		         	     		 ...
		         	     		 $.each(boqArray, function (i, value) { 
		    					 	ReportArrayGlobal.push({
		    							...
		    							siteID: ((boqArray[i].siteID) == null)? "" : boqArray[i].siteID,
		    							siteName: ((boqArray[i].wareName) == null)? "" : boqArray[i].wareName,
