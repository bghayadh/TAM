...
<div class="container">
	...
	<div class="modal-body">
	 <ul class="nav nav-tabs" id="myTab" role="tablist" style="background-color: #00757C;">
  		...
  		<li class="nav-item">
   			 <a class="nav-link " id="clientinfo-tab" style="color: gold;" data-toggle="tab" href="#clientinfo" role="tab" aria-controls="clientinfo" aria-selected="false">Company Info</a>
  		</li>
						...
						<ul class="nav nav-tabs" id="custom-tabs-one-tab" role="tablist"
							...
							<li class="nav-item">
								<class="nav-link inactive" id="custom-tabs-one-home-tab"
									style="color: gold;text-align:center;line-height:2.75em; padding-left:5px;">COMPANIES
									LIST
							</li>
							...
							<li class="nav-item ml-auto">
								...
								<button type="button" id="saveButton"
									onclick='window.location.href = "${pageContext.request.contextPath}/CompanyFormView?type=addNew"'
				...
				$(document).ready(function () {
					...
					var almgrid = new Almgrid({
	     			...
	     			$("#popUpSubmit").on("click", function (e) {
    					...
    					+'<th>Company Number <li class="filter-dropdown dropdown"><button class="almgrid-filter" data-toggle="dropdown">'
                	...
                	$.ajax({
        					...
        					url : "${pageContext.request.contextPath}/FilteredCompanyListView",
        							...
        							selectCheckbox: true
        		             		...
        		             		$("#searchClient").css('background', '#da6815');
										...
										$(".almgrid-table").on("click", ".almgrid-link", function (e) {
	        								...
	        								var param = "${pageContext.request.contextPath}/CompanyFormView?clientID=" + param1 +"&NavAction=2";
					...
					$( "#Fview" ).click(function() {
						var id =  $(".almgrid-link").closest('tr').find('td:first-child input').val();
		  				location.href="${pageContext.request.contextPath}/CompanyFormView?clientID="+id+"&NavAction=2";
					});
					...
					$("#deleteButton").click(function () {
						...
						$.ajax({
							type: "GET",
							url: "${pageContext.request.contextPath}/CompanyListViewDelete",
							dataType: "json",
							data: {
					...
					//method to export the data into excel sheet
	             	function exportGrid() {
	           		  ...
	           		  downloadCSVFile(exportArrayGrid, "CompaniesReport");
					...
					//filling the grid with the needed data
	             	function fillGrid(filledGrid){
	             		...
	             		var data=[];
						data.push('\r');
						data.push(["Company ID","Mobile Number", "First Name", "Last Name", "Created Date","Last Modified Date","Status","Registration Status"]);
	             ...
	             // Resize and drag the popup
        			...
        			/*function clearFields()
        			{
        				$("#popupstartdate").val('');
        				$("#popupenddate").val('');
        				$("#popupMobileNumber").val('');
        				$("#popupFname").val('');
        				$("#popupLname").val('');
        				$("#popupStatus").val('');
        				$("#popupRegStatus").val('');
        				$("#popupTkashStatus").val('');
