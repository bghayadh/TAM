...
<div class="container-fluid">
			...
			<div class="col-md-3">
                   <div class="form-group">
						<div class="input-group-prepend">
							<span class="input-group-text" style="color:green">FiscalYear </span>
							<input type="text" id="suppcode" readonly  value="${fiscalyearID}" class="form-control text-input"   />
		...
		<div class="col-md-3 nextprvItems">
			<div class="form-group">
				<div class="input-group-prepend">
					<span class="input-group-text">Other FiscalYear</span>
		 		...
		 		<div class="btn-group pull-right">
		 			<div class="glyph">
			        	...
			        	<button type="button" id="Lview"  class="btn btn-light" data-toggle="tooltip"
			        			onclick='window.location.href = "${pageContext.request.contextPath}/FisaclYearListView"'
...
<div class="tab-content" id="custom-tabs-one-tabContent">
	...
	<div class="row">
		<div class="col-md-4">
				<div class="form-group">
					<div class="input-group-prepend">
						<span class="input-group-text">FisalYear Name</span>
						<input type="text" id="suppname" value="${fiscalyearName}"  class="form-control text-input" />
					</div>
				</div>
		</div>
		...
		<div class="col-md-4">
			<div class="input-group-prepend">
				<span class="input-group-text">FiscalYear Country</span>
		...
		<div class="col-md-4">
			<div class="input-group-prepend">
				<span class="input-group-text">FiscalYear Category</span>
	...
	<div class="row">
		...
		<div class="col-md-4">
			<div class="form-group">
				<div class="input-group-prepend">
					<span class="input-group-text" style="width:180px;">FiscalYear Tax</span>
					<input type="text" id="supptxid" value="${fiscalyearTaxid}" class="form-control text-input"/>
				</div>
			</div>
		</div>
		...
		<div class="col-md-4">
			<div class="form-group">
				<div class="input-group-prepend">
					...
					<input type="text" id="suppcrdlimit" value="${fiscalyearCreditlimit}" class="form-control text-input" />
				</div>
			</div>
		</div>
	...
	<div class="row">
		<div class="col-md-8">
			<div class="input-group-prepend">
				<span class="input-group-text">FiscalYear Description</span>
			</div>							
		</div>
	</div>
	...
	<div class="row">
		<div class="col-md-5">
			<div class="input-group-prepend">
				<textarea name="suppdescrip" cols="220" rows="8" id="suppdescrip"> ${fiscalyearDescription} </textarea>
			</div>							
		</div>
	</div>
