...
<%@taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
	...
	<head>
		<meta charset="utf-8">
		<title>Fixed Asset Register List View</title>
					...
					<div class="col-md-4">
						<div class="form-group">
							<div class="input-group-prepend">
								...
								<input type="text" readonly value="${totalInitialCost}"
					...
					<div class="col-md-4">
						<div class="form-group">
							<div class="input-group-prepend">
								...
								<input type="text" readonly value="${totalNetCost}" class="form-control text-input" />
							</div>
						</div>
					</div>
				</div>
					...
					<div class="col-md-8">
						<div class="form-group">
							<div class="input-group-prepend">
								...
								<input type="text" readonly value="${totalAccumdepr}" class="form-control text-input" />
							</div>
						</div>
					</div>
	...
	<button type="button" id="popUpCancel" class ="btn btn-default btn-primary BtnActive" style="color:white;position:relative;">Cancel</button>
				...
				<div class="row">
					<div class="col-12 col-sm-12 col-lg-12">
						<ul class="nav nav-tabs" id="custom-tabs-one-tab" role="tablist"
							...
							<li class="nav-item">
								<class="nav-link inactive" id="custom-tabs-one-home-tab" style="color: gold;center;line-height:2.75em; padding-left:5px;">FIXED ASSET REGISTER LIST
							</li>
							...
							<li class="nav-item ml-auto">
								...
								<button type="button" id="saveButton"
									onclick='window.location.href = "${pageContext.request.contextPath}/FixedAssetRegistryFormView?type=addNew"'
					...
					<div class="row">
						<div class="col-sm-12">
							<div class="almgrid-container">
								...
								<div id="fixedassetgridtable"class="table-responsive almgrid-table-div">
			...
			<script>
				...
				$(document).ready(function () {
					...
					$.each(farListData, function (i, value) {
						ReportArrayGlobal.push({
							ID: value[0], // This is mandatory for value of checkbox, the rest are drawn in table
							farId: value[0],
							itemCode: value[1],
							itemName: value[2],
							lastModifiedDate: value[3],
							itemSerialNumber: value[4],
							itemNameRegister: value[5],
							poId: value[6],
							nodeId: value[7],
							nodeName: value[8],
							siteId: value[9]
					...
					$("#deleteButton").click(function () {
						...
						$.ajax({
							type: "GET",
							url: "${pageContext.request.contextPath}/FixedAssetRegistryListViewDelete",
							dataType: "json",
							data: {
								"farID": deleteArray
							},
					...
					$(".almgrid-table").on("click", ".almgrid-link", function (e) {
						...
						var param = "${pageContext.request.contextPath}/FixedAssetRegistryFormView?farID=" + param1+"&NavAction=2";
...
download_link.download = "FixedAssetRegistry_List_Export";
...
//location.reload();
					...
					$("#Fview").click(function () {
						...
						var param = "${pageContext.request.contextPath}/FixedAssetRegistryFormView?farID=" + id+"&NavAction=2";
						window.location.href = param;
					});
				  	...
				  	$("#popUpSubmit").click(function() {
				  		$("#poModal").modal("show");
				 		$("#gridTable").remove();
				 		$("#fixedassetgridtable").append('<table id="gridTable" class="table table-striped table-bordered almgrid-table"><thead>'
				 				+'<tr class="header">'
				 		...
				 		$.ajax({
							...
							url : "${pageContext.request.contextPath}/FilteredFixedAssetListView",
						...
						success : function(data) {
								...
								if(data!=null){
									...
									selectCheckbox: true
				             		...
				             		$(".almgrid-table").on("click", ".almgrid-link", function (e) {
				             			var param1 = $(this).attr('id');
				             			var param = "${pageContext.request.contextPath}/FixedAssetRegistryFormView??ID=" + param1 +"&NavAction=2";
				             			window.location.href = param;
				             			e.preventDefault();
				             		});
								}	
