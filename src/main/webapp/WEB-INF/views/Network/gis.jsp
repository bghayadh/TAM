...
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/resources/css/leaflet-routing-machine.css"/>
	<script src="https://unpkg.com/leaflet@1.3.1/dist/leaflet.js"></script>
<script src="https://npmcdn.com/leaflet-geometryutil"></script>
	<script src="${pageContext.request.contextPath}/resources/js/leaflet-routing-machine.js"></script>
	<script src="${pageContext.request.contextPath}/resources/js/Control.Geocoder.js"></script>
...
function setSearchMap(from,array) {
	...
	$(document).ready(function() {
						...
						/*	 L.Routing.control({
						    	 waypoints: [
						    			L.latLng(34.0731374116421, 35.7659912109375),
						    			L.latLng(34.40464357107094, 36.123046875)
						    		],
						    	}).addTo(mymap);*/
							//var marker = L.marker([34.40464357107094,36.123046875]).addTo(mymap);
							var drawnItems = new L.FeatureGroup();
						     ...
						     control1.on('routesfound', function(e) {
						    	  ...
						    	  var _distance = L.GeometryUtil.distance(mymap,{lat: 34.0731374116421, lng: 35.7659912109375} , {lat: 34.40464357107094, lng: 36.123046875});
						    	  var _length = L.GeometryUtil.length( [mymap.latLngToLayerPoint([33.87953701355924, 35.53802490234375]), mymap.latLngToLayerPoint([33.58259116393916,35.419921875])]);  
						    	  alert(_distance +" px "+_length+" km");
							    	});
						    	L.Routing.errorControl(control1).addTo(mymap);
							...
							if (maps.length != 0) {
								...
								if (maps.length <= 10) {
									...
									for (var i = 0; i < maps.length; i++) {		
									   ...
									   singleM = L.marker([ maps[i][2], maps[i][3] ], {id:maps[i][0],icon: myIcon},{riseOnHover: true}).addTo(mymap);
												...
												+ " !</b><br> site name: " + maps[i][1] + " !").on('mouseover', function(e) {
												  ...
												  .on('mouseout', function(e) {
												    ...
												    this.setOpacity(0.5)
													  ...
													  //get info for this marker
													 // alert(e.sourceTarget.options.id);
													  getMarkerInfo(e.sourceTarget.options.id);
						...
						function getMarkerInfo(markerId){
							...
							$.ajax({
								type : "GET",
								contentType : "application/json; charset=utf-8",
								url : '${pageContext.request.contextPath}/getMarkerInfo',
								data : {
									"markerId": markerId,
								},
								dataType : "json",
						 ...
						 function setMarkerInfo(markerInfo){
							console.log(markerInfo);
							var table = $('#example').DataTable( {
								"bProcessing": true,
							    "aaData":markerInfo ,// <-- your array of objects
							    "aoColumns":[
							    	{
							        	"mData": null,
							          	"bSortable": false,
								        "mRender" : function ( markerInfo, type, full ) { 
							        ...
							        
							        {
							            ...
							            "mRender": function(url, type, full) {
							                console.log(full[0]);
							            	return    '<a href="'+ '${pageContext.request.contextPath}/WarehouseFormView?wareID='+full[0] +'&warehouseName='+full[3] +'">' + url + '</a>';
											}
							       ...
							       },
							      {
							           ...
							           "sType": "String",
							           "mRender": function(url, type, full) {
							               if(full[1] == null){return '';}else{
							           	return    '<a href="'+ '${pageContext.request.contextPath}/SiteFormView?siteid='+full[1] +'">'+ url + '</a>';
							               }
											}
							         },
							         {
						...
						$('#itmCode').autocomplete(
										{
											...
											source : function(request,
												...
												$
														.ajax({
															...
															url : '${pageContext.request.contextPath}/GetItemBOQ',
															data : {
																"itemCode" : itemCode,
																"itemModel" : itemModel,
																"Item_PartNum" : "1",
											...
											scroll : true,
											select : function(event, ui) {
												console.log("log" + ui.item[0]
														+ ":" + ui.item[1]);
												itmCode.value = (ui.item ? ui.item[0]
														+ ":" + ui.item[1]
														: '');
												itmModel.value = ui.item[2];
