...
select
 ...
 #gridTable #CabinetTable #SubrackTable #SLotTable #AntennaTable #PortTable 
        {
        ...
        #gridTable #CabinetTable #SubrackTable #SLotTable #AntennaTable #PortTable   td, #gridTable#CabinetTable #SubrackTable #SLotTable #AntennaTable #PortTable  th {
        border: 3px solid black;
        text-align: center;
        }
        #gridTable #CabinetTable #SubrackTable #SLotTable #AntennaTable #PortTable  tr:first-child td {
        border-top: 0;
        }
        #gridTable #CabinetTable #SubrackTable #SLotTable #AntennaTable #PortTable  tr td:first-child {
        border-left: 0;
        }
        #gridTable #CabinetTable #SubrackTable #SLotTable #AntennaTable #PortTable  tr:last-child td {
        border-bottom: 0;
        }
        #gridTable #CabinetTable #SubrackTable #SLotTable #AntennaTable #PortTable  tr td:last-child {
        border-right: 0;
        }

        #gridTable #CabinetTable #SubrackTable #SLotTable #AntennaTable #PortTable  tr#search_by_column td 
        {
            padding: 8px;
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            <div class="input-group-prepend">
                                ...
                                <input type="text" id="nodename" value="${NodeName}"
									...
									<div class="col-md-4">
										<div class="form-group">
											<label class='required'>BTS Type-Main Cabinet</label> <input
												type="text" id="btsmain" readonly value="${btsType}"
												class="form-control text-input" />
										</div>
									</div>
									...
									<div class="col-md-4">
										<div class="form-group">
											<label class='required'>BTS Type Expansion 1/MBC
												Cabinet</label> <input type="text" id="btstype1" readonly
									...
									<div class="col-md-4">
										<div class="form-group">
											<label class='required'>BTS Type Expansion 2/MBC
												Cabinet</label> <input type="text" id="btstype2" readonly
									...
									<div class="col-md-4">
										<div class="form-group">
											<label class='required'>Band BTS Type Expansion 2/MBC
												Cabinet</label> <input type="text" id="bandbts2" readonly
								...
								<div class="col-md-4">
										<div class="form-group">
											<label class='required'>Technology</label> <input type="text"
												id="nodetechnology" readonly value="${Technology}"
												class="form-control text-input" />
										</div>
									</div>
									...
									<div class="row">
										...
										<div class="col-sm-4">
											...
											<div class="input-group mb-3">
												...
												<input class="form-control" id="dateonairbts1" type="date">
											</div>
										</div>
										<div class="col-sm-4">
											<label class='required'>Date On Air-BTS
											...
											<div class="input-group mb-3">
												...
												<input class="form-control" id="dateonairbts2"type="date">
											</div>
										</div>
									</div>
									<div class="row">
										<div class="col-sm-3">
											<div class="form-group">
												<label class='required'>Swap (Y/N)</label> <select
													id="swap" class="form-control select2">
													<option value="Y"
