						...
						<div class="btn-group pull-right">
							<div class="glyph">
								...
								<button type="button" id="Fview" class="btn btn-light" data-toggle="tooltip"
									...
									onclick='window.location.href = "${pageContext.request.contextPath}/GoodsRcvFormView"'> 
								...
								<button type="button" id="searchGoods" class="btn btn-light" data-toggle="tooltip" data-placement="top"
									title="Search">
...
<div class="container">
	...
	<div class="modal-body">
	 <ul class="nav nav-tabs" id="myTab" role="tablist" style="background-color: #00757C;">
  		...
  		<li class="nav-item">
   			 <a class="nav-link " id="warehouseinfo-tab" style="color: gold;" data-toggle="tab" href="#warehouseinfo" role="tab" aria-controls="warehouseinfo" aria-selected="false">Warehouse Info</a>
  		</li>
...
<div class="tab-pane" id="warehouseinfo" role="tabpanel" aria-labelledby="warehouseinfo-tab">
<p></p>
<div class="container-fluid">
	<div class="row">
		<div class="col-sm-6">
			<div class="form-group">
				<div class="input-group-prepend">
					...
					<input type="text" class="ui-widget ui-widget-content ui-corner-all form-control text-input" id="popupwarehouse" style="width:675px; height:37px"  />					
				</div>
			</div>
		</div>
						...
						<ul class="nav nav-tabs" id="custom-tabs-one-tab" role="tablist"
							...
							<li class="nav-item">
								<class="nav-link inactive" id="custom-tabs-one-home-tab"
									style="color: gold;text-align:center;line-height:2.75em; padding-left:5px;">
									GOODS RECEIVED LIST
							</li>
							...
							<li class="nav-item ml-auto">
								...
								<button type="button" id="saveButton"
									onclick='window.location.href = "${pageContext.request.contextPath}/GoodsRcvFormView?type=addNew&NavAction=2"'
					...
					<div class="row">
						<div class="col-sm-12">
							<div class="almgrid-container">
								...
								<div id="GoodsGridTable"  class="table-responsive almgrid-table-div">
...
var goodsRcvData = ${ListGridTable};

	$(document).ready(function() {
						var ReportArrayGlobal = [];
						// TO READ FROM DATABASE
						$.each(goodsRcvData, function(i, value) {
							ReportArrayGlobal.push({
								ID : value[1],// This is mandatory for value of checkbox, the rest are drawn in table
								GR_ID : value[1],
								GR_LAST_MODIFICATION_DATE : value[2],
								GR_SUPPLIER : value[3],
								GR_TOTAL_AMOUNT : value[4],
								GR_TOTAL_QTY : value[5],
								GR_WAREHOUSE : value[6],
								GR_SITE_ID : value[7],
								GR_WAREHOUSE_NAME : value[8],
...
download_link.download = "GoodsRcv_List_Export";
...
exportArrayGrid.push(["GR_ID", "LAST MODIFICATION DATE", "SUPPLIER NAME", "TOTAL AMOUNT", "TOTAL QTY","WAREHOUSE","SITE ID", "WAREHOUSE NAME"]);
...
//location.reload();
						...
						$(".almgrid-table").on("click",".almgrid-link",function(e) {
											...
											var param = "${pageContext.request.contextPath}/GoodsRcvFormView?ID="+ param1+ "&NavAction=2";
					...
					$("#searchGoods").click(function() {
					 		$("#poModal").modal("show");
					 		document.getElementById('searchGoods').className = 'btn btn-danger';
					     	document.getElementById('Lview').className = 'btn btn-light';
					     	$("#Lview").css('background', '#FFFFFF');	
					 		$("#searchGoods").css('background', '#da6815');	
					  	...
					  	$("#popUpSubmit").click(function() {
					  		$("#poModal").modal("show");
					 		$("#gridTable").remove();
					 		$("#GoodsGridTable").append('<table id="gridTable" class="table table-striped table-bordered almgrid-table"><thead>'
					 				+'<tr class="header">'
					 				+'<th class="table-select-all"></th>'
					 				+'<th>Goods Rcv ID <li class="filter-dropdown dropdown"><button class="almgrid-filter" data-toggle="dropdown"> <i class="fa fa-list almgrid-filter-i" aria-hidden="true"></i></button>'
					 				...
					 				+'<ul class="dropdown-menu dropdown-menu-right filter-dropdown-ul"></ul></li></th>'
					 				+'<th>Warehouse ID <li class="filter-dropdown dropdown"><button class="almgrid-filter" data-toggle="dropdown"><i class="fa fa-list almgrid-filter-i" aria-hidden="true"></i></button>'
					 				+'<ul class="dropdown-menu dropdown-menu-right filter-dropdown-ul"></ul></li></th>'
					 		...
					 		$.ajax({
								...
								url : "${pageContext.request.contextPath}/FilteredGoodsListView",
								
								data : {
									"startDate":$("#popupstartdate").val(),
									"endDate":$("#popupenddate").val(),
									"Supplier":$("#popupSupplier").val(),
									"Warehouse":$("#popupwarehouse").val(),
							},
					 ...
					 // Resize and drag the popup
						...
						//{$("#popupstartdate").val('');$("#popupenddate").val('');$("#popupsupplier").val('');$("#popupwarehouse").val('');}
