						...
						<ul class="nav nav-tabs" id="custom-tabs-one-tab" role="tablist"
							...
							<li class="nav-item">
								<class="nav-link inactive" id="custom-tabs-one-home-tab"
									style="color: gold;text-align:center;line-height:2.75em; padding-left:5px;">PURCHASE ORDER LIST
							...
							<li class="nav-item ml-auto">
								...
								<button type="button" id="saveButton"
									onclick='window.location.href = "${pageContext.request.contextPath}/PurchaseOrderFormView?type=addNew"'
...
<!--------------------------------------------------  END card-header ------------------------------------------>
								...
								<div id="purchaseOrderGridTable" class="table-responsive almgrid-table-div">
									<table id="PurchaseOrdTable" class="table table-striped table-bordered almgrid-table">
										<thead>
											<tr class="header">
...
$( "#Fview" ).click(function() {	
	var id =  $('#PurchaseOrdTable tbody tr:eq(0) td:eq(1)').text();
...
////////////////////////////////////////for link
	$(".almgrid-table").on("click", ".almgrid-link", function (e) {
		...
		var param = "${pageContext.request.contextPath}/PurchaseOrderFormView?ID=" + param1 +"&NavAction=2";
...
$("#deleteButton").click(function () {
	...
	$("#PurchaseOrdTable").find(".table-select-checkbox").each(function () {
		if ($(this).is(":checked")) {
	...
	//filling the grid with the needed data
 	...
 	$("#export").click(function() {
  	...
  	$("#popUpSubmit").click(function() {
  		$("#poModal").modal("show");
 		$("#PurchaseOrdTable").remove();
 		$("#purchaseOrderGridTable").append('<table id="PurchaseOrdTable" class="table table-striped table-bordered almgrid-table"><thead>'
 				+'<tr class="header">'
