					...
					<div class="glyph">
					  <button class="btn btn-secondary" type="button" id="export">Export</button>
						<button type="button" id="Fview" class="btn btn-light"
							...
							onclick='window.location.href = "${pageContext.request.contextPath}/WorkOrderFormView"'>
						...
						<button type="button" id="searchworkorder" class="btn btn-light" data-toggle="tooltip" data-placement="top"
									title="Search">
...
<div class="container">
	...
	<div class="modal-body">
	 <ul class="nav nav-tabs" id="myTab" role="tablist" style="background-color: #00757C;">
  		...
  		<li class="nav-item">
   			 <a class="nav-link " id="warehouse-tab" style="color: gold;" data-toggle="tab" href="#warehouse" role="tab" aria-controls="warehouse" aria-selected="false">Warehouse</a>
  		</li>
...
<div class="tab-pane" id="warehouse" role="tabpanel" aria-labelledby="warehouse-tab">
<p></p>
<div class="container-fluid">
	<div class="row">
		<div class="col-sm-6">
			<div class="form-group">
				<div class="input-group-prepend">
					<span class="input-group-text" >WareHouse From</span>
					<input type="text" class="ui-widget ui-widget-content ui-corner-all form-control text-input" id="popupwarehousefrom" style="width:675px; height:37px"  />					
				</div>
			</div>
		</div>
		<div class="col-sm-6">
			<div class="form-group">
				<div class="input-group-prepend">
					<span class="input-group-text" >WareHouse To</span>
					<input type="text" class="ui-widget ui-widget-content ui-corner-all form-control text-input" id="popupwarehouseto" style="width:675px; height:37px"  />					
				</div>
			</div>
		</div>
		...
		<div class="row">
			<div class="col-12 col-sm-12 col-lg-12">
				<ul class="nav nav-tabs" id="custom-tabs-one-tab" role="tablist"
					...
					<li class="nav-item" class="nav-link inactive"
						id="custom-tabs-one-home-tab"
						style="color: gold; center; line-height: 2.75em; padding-left: 5px;">WORK
						ORDER LIST</li>
			...
			<div class="row">
				<div class="col-sm-12">
					<div class="almgrid-container">
						...
						<div id="workordergridtable" class="table-responsive almgrid-table-div">
							<table id="gridTable"
										...
										<ul class="pagination pagination-buttons justify-content-end">
											...
											<li class="page-item dropdown-pagination-numbers">
												...
												<div class="input-group page-number-group-div">
													<input type="text"
														class="form-control page-number-select shadow-none" /> <input
														type="text"
...
<script>
	...
	var ReportArrayGlobal = ${WorkOrderDt};
...
//////////////////////////////////////////////////////////////////////////export button
						...
						//method to export the data into excel sheet
							function exportGrid() {
								...
								download_link.download = "WorkOrder_List_Export";
						...
						$('#Fview').click(function(e) {
							 ...
							 var param = "${pageContext.request.contextPath}/WorkOrderFormView?type=addNew";
							 window.location.href = param;
							 e.preventDefault();
							 }
						       ...
						       var param = "${pageContext.request.contextPath}/WorkOrderFormView?workOrdId=" + firstCell+"&NavAction=2";
							   window.location.href = param;
							   e.preventDefault();
							  }
					  	...
					  	$("#searchworkorder").click(function() {
					 		$("#poModal").modal("show");
					 		document.getElementById('searchworkorder').className = 'btn btn-danger';
					     	document.getElementById('Lview').className = 'btn btn-light';
					     	$("#Lview").css('background', '#FFFFFF');	
					 		$("#searchworkorder").css('background', '#da6815');	
					  	...
					  	$("#popUpSubmit").click(function() {
					  		$("#poModal").modal("show");
					 		$("#gridTable").remove();
					 		$("#workordergridtable").append('<table id="gridTable" class="table table-striped table-bordered almgrid-table"><thead>'
					 				+'<tr class="header">'
					 				+'<th class="table-select-all"></th>'
					 				...
					 				+'<ul class="dropdown-menu filter-dropdown-ul"></ul></li></th>'
					 				+'<th>Execution Date<li class="filter-dropdown dropdown"><button class="almgrid-filter" data-toggle="dropdown"><i class="fa fa-list almgrid-filter-i" aria-hidden="true"></i></button>'
					 		...
					 		$.ajax({
								...
								url : "${pageContext.request.contextPath}/FilteredWorkOrderListView",
								
								data : {
									"startDate":$("#popupstartdate").val(),
									"endDate":$("#popupenddate").val(),
									"warehousefrom":$("#popupwarehousefrom").val(),
									"Warehouseto":$("#popupwarehouseto").val(),
							},
							dataType : "json",
							success : function(data) {
					...
					//	function clearFields()
						//{$("#popupstartdate").val('');$("#popupenddate").val('');$("#popupwarehousefrom").val('');$("#popupwarehouseto").val('');}
