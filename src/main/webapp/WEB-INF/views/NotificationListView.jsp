...
<!--  end of general head page -->
		 		...
		 		<div class="btn-group pull-right">
		 			<div class="glyph">
			 			<button  type="button" id="Fview"  class="btn btn-light" data-toggle="tooltip" 
			 				data-placement="top" title="Form View"  onclick='window.location.href = "${pageContext.request.contextPath}/NotificationFormView"'> <i class="fa fa-edit"></i>
			        	</button>
			        	<button type="button" id="Lview"  class="btn btn-danger" data-toggle="tooltip" onclick='window.location.href = "${pageContext.request.contextPath}/NotificationListView"'
	...
	<p></p>
		...
		<div class="col-12 col-sm-12 col-lg-12">	
		      <ul class="nav nav-tabs" id="custom-tabs-one-tab" role="tablist" style="background-color: #007b7c; margin-top: 0px;">
		             <li class="nav-item"><class="nav-link inactive" id="custom-tabs-one-home-tab"  style="color: gold;center;line-height:2.75em; padding-left:5px;"> NOTIFICATION LIST</li>
		            ...
		            <li class="nav-item ml-auto">
						...
						<button type="button" id="saveButton" onclick='window.location.href = "${pageContext.request.contextPath}/NotificationFormView?type=addNew"'
						class="btn btn-primary BtnActive">
	...
	$(document).ready(function() {
		...
		console.log("testing NotificationListView");
		...
		$(".almgrid-table").on("click", ".almgrid-link", function (e) {
			...
			var param = "${pageContext.request.contextPath}/NotificationFormView?id=" + param1;
		...
		$("#deleteButton").click(function () {
			...
			$.ajax({
				type: "GET",
				url: "${pageContext.request.contextPath}/NotificationListViewDelete",
				dataType: "json",
				data: {
					"ID": slct
				},
		...
		$("#Fview").click(function () {
			...
			if (obj[0] == null){
				var param = "${pageContext.request.contextPath}/NotificationFormView?type=addNew"
				}else{
