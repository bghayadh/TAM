...
(function() {
  ...
  $.extend(true, $.ui.dialogExtend.prototype, {
    ...
    maximize: function() {
      ...
      $(this.element[0]).dialog("widget").css("position", "relative").find(".ui-dialog-content").show().dialog("widget").find(".ui-dialog-buttonpane").show().end().find(".ui-dialog-content").dialog("option", {
        "resizable": true,
        "draggable": true,
        "height": newHeight,
        "width": newWidth,
